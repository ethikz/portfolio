...
/*==========================================================================
  ...
  /* Undo Fullscreen Hero */
  function unResizeHero() {
    $('#hero').removeAttr('style');
  }


  /* Animate header at waypoint */
  function resizeNav() {
    var $head = $('#header');
    $($head).addClass('header-large');
    $('.waypoint-header').each( function(i) {
      var $el = $(this),
  ...
  function webfonts() {
    WebFontConfig = {
      google: { families: ['Raleway:100,600', 'Source Sans Pro:400,700'] }
    };
    (function() {
